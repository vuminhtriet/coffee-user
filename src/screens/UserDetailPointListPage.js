...
import DetailPointManagement from '../modules/user/containers/DetailPointManagement'

export default class UserDetailPointListPage extends Component {
  constructor(props) {
    super(props)
    this.state = {
      addPayment: false
