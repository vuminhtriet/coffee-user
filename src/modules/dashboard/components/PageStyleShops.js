...
export default class PageStyleShops extends Component {
  constructor(props) {
    super(props)
  ...
  onSort = (id) => {
    ...
    if (sortType.id === id) {
      ...
      this.setState({ refreshing: true, showSort: !showSort }, async () => {
        await getStyleShops(styleId, 0, newSortType.value, options)
